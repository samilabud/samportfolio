        ...
        <div className="row about-wrapper">
          ...
          <div className="col-md-6 col-sm-12">
            <div className="about-wrapper__info">
              ...
              <p className="about-wrapper__info-text">
              Currently, I'm a team leader at a development department inside IT in BHD Leon,
              I like to be involved in building software from scratch, optimize applications, looking for bugs and fix them,
              ...
              <span className="d-flex mt-3">
                <a target="_blank" rel="noreferrer" className="cta-btn cta-btn--resume" href="/assets/Samil_Abud_Resume.pdf">
                  See Resume
                </a>
                <a target="_blank" class="cta-btn" href="https://www.codewars.com/users/samilabud">
                  <img width="350" src="https://www.codewars.com/users/samilabud/badges/small" />
                </a>
              </span>
            </div>
          </div>
        ...
        <div className="project-wrapper">
          ...
          <div className="row">
            <div className="col-lg-4 col-sm-12">
              <div className="project-wrapper__text">
                <h3 className="project-wrapper__text-title">Web Project - Juguitos Light</h3>
                <div>
                  <p className="mb-4">
                  Web portal built with PHP / WordPress. The CSS, Images, and Optimizations of the portal done by me. 
                  This portal is oriented to sell low calories beverages to people that want to get lose weight as people that are diabetics
                  </p>
                </div>
              ...
              <div className="project-wrapper__image">
                <a href="https://juguitoslight.com" target="_blank" rel="noreferrer">
                  <div data-tilt className="thumbnail rounded">
                    <img className="img-fluid" src="./assets/project.jpg" alt="Web Project - Juguitos Light" />
                  </div>
                </a>
              </div>
            </div>
          ...
          { /* /END Project */ }
           ...
           <div className="row">
            <div className="col-lg-4 col-sm-12">
              <div className="project-wrapper__text">
                <h3 className="project-wrapper__text-title">Web Project - E-commerce</h3>
                <div>
                  <p className="mb-4">
                    Final Project created with Zero to Mastery team (Complete React Developer in 2021). 
                    Developed using React (Redux, Hooks, Saga, HOC, GraphQL), integrated with Stripe and with Firebase.
         You can register and try to buy any item from your PC or from your Mobile.
                  </p>
                </div>
            ...
            <div className="col-lg-8 col-sm-12">
              <div className="project-wrapper__image">
                <a href="https://samcrowncommerce.herokuapp.com/" target="_blank" rel="noreferrer">
                  <div data-tilt className="thumbnail rounded">
                    <img className="img-fluid" src="./assets/projectSamCommerce.jpg" alt="Web Project - SamCommerce" />
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-sm-12">
              <div className="project-wrapper__text">
                <h3 className="project-wrapper__text-title">Web Project - FaceRecognition</h3>
                <div>
                  <p className="mb-4">
                  Final Project created with Zero to Mastery team (The Complete Web Developer in 2020). 
          Built with React (HTML, CSS, JavaScript), this uses an API (https://apifacesrecognition.herokuapp.com/) created in class too, at general way is based in NodeJS, Express, PostgreSQL con KnexJS.
          You can register and try to scan any image and this application will detect faces using Clarifai's AI.
                  </p>
                </div>
            ...
            <div className="col-lg-8 col-sm-12">
              <div className="project-wrapper__image">
                <a href="https://webfacesrecognition.herokuapp.com" target="_blank" rel="noreferrer">
                  <div data-tilt className="thumbnail rounded">
                    <img className="img-fluid" src="./assets/projectAFR.jpg" alt="Web Project - FaceRecognition" />
                  </div>
                </a>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-4 col-sm-12">
              <div className="project-wrapper__text">
                <h3 className="project-wrapper__text-title">Web Project - RoboFriends</h3>
                <div>
                  <p className="mb-4">
                    This project had been created with Zero to Mastery's team. 
                    Built with React (HTML, CSS, JavaScript), uses an API, is organized and optimized.
                  </p>
                </div>
            ...
            <div className="col-lg-8 col-sm-12">
              <div className="project-wrapper__image">
                <a href="http://samrobofriends.netlify.app" target="_blank" rel="noreferrer">
                  <div data-tilt className="thumbnail rounded">
                    <img className="img-fluid" src="./assets/projectrf.jpg" alt="Web Project - RoboFriends" />
                  </div>
                </a>
              </div>
            </div>
